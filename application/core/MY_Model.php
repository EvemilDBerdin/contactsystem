...
class MY_Model extends CI_Model
{
    ...
    // CI pagination
    public function recordCount($tname)
    {
        return $this->db->count_all($tname);
    }

    public function fetchRecords($limit, $start, $tname, $condition)
    { 
    ...
    // search model
    public function searchModel($tblname, $query, $limit, $start) {
        $this->db->like('name', $query); // Assuming you're searching in a 'name' column
        $this->db->or_like('company', $query);
        $this->db->or_like('phone', $query);
        $this->db->or_like('email', $query);
        $this->db->limit($limit, $start);
        $query = $this->db->get($tblname); // Replace 'your_table' with your actual table name
    ...
    public function countSearchResultsModel($tblname, $query) {
        $this->db->like('department_id', $query);
