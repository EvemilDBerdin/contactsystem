...
if(!function_exists('record_count')){
	function record_count($tname){
		$ci = &get_instance();
		return $ci->MY_Model->recordCount($tname);
	}
}
if(!function_exists('fetch_records')){
	function fetch_records($limit, $start, $tname, $condition){
		$ci = &get_instance();
		return $ci->MY_Model->fetchRecords($limit, $start, $tname, $condition);
	}
}
if(!function_exists('search')){
	function search($tblname, $query, $limit, $start){
		$ci = &get_instance();
		return $ci->MY_Model->searchModel($tblname, $query, $limit, $start);
	}
	// function search($tblname, $query){
	// 	$ci = &get_instance(); 
	// 	return $ci->MY_Model->search_like($tblname, $query);
	// }
}
if(!function_exists('countSearchResults')){
	function countSearchResults($tblname, $query){
		$ci = &get_instance();
		return $ci->MY_Model->countSearchResultsModel($tblname, $query);
	}
}
